const props = {
    config:{
        title: '— $14.99',
        twitter: 'https://twitter.com/codetonero',
        brew: 'https://github.com/LaB-CH3/astrobrew',
        buy_url: 'https://buy.stripe.com/cN26op5Yh6kT03CcMN',
        mailto: `hello@anthonycharles.work`,
